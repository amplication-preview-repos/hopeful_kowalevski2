...
class ContentCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => DmcaRequestCreateNestedManyWithoutContentsInput,
  })
  @ValidateNested()
  @Type(() => DmcaRequestCreateNestedManyWithoutContentsInput)
  @IsOptional()
  @Field(() => DmcaRequestCreateNestedManyWithoutContentsInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => LogCreateNestedManyWithoutContentsInput,
  })
  @ValidateNested()
  @Type(() => LogCreateNestedManyWithoutContentsInput)
  @IsOptional()
  @Field(() => LogCreateNestedManyWithoutContentsInput, {
    nullable: true,
  })
