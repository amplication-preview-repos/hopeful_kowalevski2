  ...
  test("POST /platforms", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        lastScraped: CREATE_RESULT.lastScraped.toISOString(),
      ...
      .expect([
        {
          ...
          lastScraped: FIND_MANY_RESULT[0].lastScraped.toISOString(),
  ...
  test("GET /platforms/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        lastScraped: FIND_ONE_RESULT.lastScraped.toISOString(),
